...
function create() {
	...
	// Distance joint with all parameters defined
	{
		// Static box
		...
		game.physics.box2d.distanceJoint(spriteA, spriteB, 150, 0, 0, 0, 0, 1.5, 0.4); 
...
function update() {
	...
	if ( spriteA.body.containsPoint(game.input.mousePointer) ) {
		codeCaption.text = 'game.physics.box2d.distanceJoint(spriteA, spriteB, 150, 0, 0, 0, 0, 1.5, 0.4); ';
	} else {
        codeCaption.text = '';
    }
