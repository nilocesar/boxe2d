...
function create() {
	...
	// Motor joint with anchors at the center of each sprite and angular correction but no linear correction
	{
		// Static box
	...
	game.add.text(5, 5, 'Motor joint with angular correction but no linear correction. Click to start.', { fill: '#ffffff', font: '14pt Arial' });
