...
function create() {
	...
	// A simple revolute joint with offset anchor points
	{
		// Static box
	...
	codeCaption = game.add.text(5, 30, 'Parameters: bodyA, bodyB, ax, ay, bx, by', { fill: '#dddddd', font: '10pt Arial' });
	codeCaption = game.add.text(5, 45, 'game.physics.box2d.revoluteJoint(spriteA, spriteB, 60, 40, -10, -20);', { fill: '#ccffcc', font: '14pt Arial' });
